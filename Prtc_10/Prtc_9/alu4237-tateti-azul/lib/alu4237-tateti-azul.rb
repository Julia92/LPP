...
print "Escoja los jugadores que desa que jueguen: Humano, Smart o Dumb\n"
      jugador = $stdin.gets.chomp
      jugador2 = $stdin.gets.chomp

if(jugador=='Humano')
jugador=Alu4237::Tateti::Azul::HumanPlayer
elsif(jugador=='Smart')
jugador= Alu4237::Tateti::Azul::SmartPlayer
else
jugador= Alu4237::Tateti::Azul::DumbPlayer
end


if(jugador2=='Humano')
jugador2=Alu4237::Tateti::Azul::HumanPlayer
elsif(jugador2=='Smart')
jugador2= Alu4237::Tateti::Azul::SmartPlayer
else
jugador2= Alu4237::Tateti::Azul::DumbPlayer
end
game = Alu4237::Tateti::Azul::Game.new jugador, jugador2
game.play
end
playarbitrario
